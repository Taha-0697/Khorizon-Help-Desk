...
if (isset($_POST['UserType'],$_POST['username'], $_POST['email'], $_POST['p'])) {
   ...
   // check existing email  
    ...
    if (empty($error_msg)) {
        ...
        $sql ="INSERT INTO `users` (username, email, password, salt,UserType,groupid) VALUES ('$username', '$email', '$password', '$random_salt', '$usertype','$groupId')";
